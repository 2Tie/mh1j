...
typedef struct {
    ...
    /* 0x18 */ union {
        u32 zones_offset;
        CAM_GEOMETRY_ZONE* zones_ptr;
    };
    /* 0x1C */ union {
        u32 bytepairs_offset;
        void* bytepairs_ptr;
    };
...
typedef struct {
    ...
    /* 0x04 */ union {
        u32 entries_offset;
        CAM_DATA_ENTRY_HEADER** entries_ptr;
    };
...
typedef struct {
    ...
    /* 0x1C */ union {
        u32 cam_grid_offset;
        CAM_GRID_CELL* cam_grid_ptr;
    };
    /* 0x20 */ union {
        u32 entry_list_offset;
        CAM_DATA_ENTRY_HEADER** entry_list_ptr;
    };
    /* 0x24 */ void* eof;
    /* 0x28 */ union {
        u32 first_entry_offset;
        CAM_DATA_ENTRY_HEADER* first_entry_ptr;
    };
    /* 0x2C */ f32 unk_2c;
...
typedef struct {
    /* 0x00 */ union {
        u8 active;
        s32 active_s32;
    }; // Had to use int to match cam_init_sub_playerEX
    /* 0x04 */ s32 is_fishing;
