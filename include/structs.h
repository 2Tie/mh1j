...
typedef struct {
	    /* 0x000 */ u8 top_state;
    /* 0x001 */ u8 sub_state;
    /* 0x002 */ u8 game_top_state;
    /* 0x003 */ u8 game_sub_state;
    /* 0x004 */ u16 unk_4;
    /* 0x006 */ u16 unk_6;
    /* 0x008 */ u8 unk_8;
    /* 0x009 */ u8 unk_9;
    ...
    /* 0x012 */ u8 unk_12;
    /* 0x013 */ u8 unk_13;
    /* 0x014 */ u8 current_area_id;
    /* 0x015 */ u8 area_model;
    /* 0x016 */ u8 unk_16[0x8];
    /* 0x01E */ u16 tick_count;
    /* 0x020 */ u8 pad_0_ack;
    /* 0x021 */ u8 pad_1_ack;
    /* 0x022 */ u8 unk_22[0x3]; // 0x23 allows tasks to run when unset
    /* 0x025 */ u8 current_music;
    /* 0x026 */ s16 music_timer;
    /* 0x028 */ u8 load_monsters[4];
    /* 0x02C */ u16 selected_quest_id;
    /* 0x02E */ u8 fight_music_index;
    /* 0x02F */ u8 camp_area_id;
    /* 0x030 */ u8 unk_30[0x50];
    /* 0x080 */ u8 player_items[4];
    /* 0x084 */ u8 unk_84[0x4];
    /* 0x088 */ u32 mdl_ptrs[4];
    /* 0x089 */ u16 mdl_status[4];
    /* 0x0A0 */ u16 mdl_starts[4];
    /* 0x0A8 */ u32 sub_mdl_ptrs[4];
    /* 0x0B8 */ u16 sub_mdl_status[4];
    /* 0x0C0 */ u16 sub_mdl_starts[4];
    /* 0x0C8 */ u8 unk_C8[0x4];
    /* 0x0CC */ u16 stolen_item_id;
    /* 0x0CE */ u16 stolen_item_quantity;
    /* 0x0D0 */ u8 stolen_item_flag;
    /* 0x0D1 */ u8 my_player_number;
    /* 0x0D2 */ u8 address_id;
    /* 0x0D3 */ u8 number_of_players;
    /* 0x0D4 */ u8 hit_id;
    /* 0x0D5 */ u8 mission_state;
    /* 0x0D6 */ u8 unk_D6[0x52];
    /* 0x128 */ ITEM_SLOT quest_item_box[32];
    /* 0x1A8 */ u32 quest_item_box_taken_flags[2];
    /* 0x1B0 */ u8 unk_1B0[0x30];
    /* 0x1E0 */ u16 current_sound_effect;
    /* 0x1E2 */ u8 unk_1E2[0x5];
    /* 0x1E7 */ u8 in_tutorial;
    /* 0x1E8 */ char user_id_1[8];
    /* 0x1F0 */ char user_id_2[8];
    /* 0x1F8 */ char user_id_3[8];
    /* 0x200 */ char user_id_4[8];
    /* 0x208 */ u8 hunter_1_present;
    /* 0x209 */ u8 hunter_2_present;
    /* 0x20A */ u8 hunter_3_present;
    /* 0x20B */ u8 hunter_4_present;
    /* 0x20C */ u8 unk_20C[0x4];
    /* 0x210 */ u8 number_bombs_placed;
    /* 0x211 */ u8 number_meats_placed;
    /* 0x212 */ u8 number_traps_placed;
    /* 0x213 */ u8 unk_213[0x5];
    /* 0x218 */ u16 fatalis_health;
    /* 0x21A */ u8 unk_21A[0x3];
    /* 0x21D */ u8 fort_damage;
    /* 0x21E */ u8 unk_21e;
    /* 0x21F */ bool demo_playing;
    /* 0x220 */ u8 unk_220[0x4];
} GAME_WORK; // size: 0x224
